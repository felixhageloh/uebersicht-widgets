...
exports.increment = function(id, callback) {
  ...
  doIncrement = function() {
    ...
    return downloadCounts.save().then(function() {
      cookie.set(id, true);
      return typeof callback === "function" ? callback(downloadCounts.get(id)) : void 0;
    });
  };
  if (downloadCounts) {
    return doIncrement();
...
registerEvents = function(widgetEls) {
  ...
  $(document).on("click", '.download', function(e) {
    return setTimeout(function() {
      ...
      return downloads.increment(id, function(newCount) {
        var widget;
...
},{"../lib/jquery":1,"./download-counts.coffee":3,"./router.coffee":5,"./widget-details.coffee":7,"./widget-template.coffee":8}],5:[function(require,module,exports){
...
},{"../lib/jquery":1,"./widget-details-template.coffee":6}],8:[function(require,module,exports){
var repoLink;
